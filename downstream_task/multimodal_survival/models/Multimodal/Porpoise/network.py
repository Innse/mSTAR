...
class LRBilinearFusion(nn.Module):
    def __init__(self, skip=0, use_bilinear=0, gate1=1, gate2=1, dim1=128, dim2=128, scale_dim1=1, scale_dim2=1, dropout_rate=0.25, rank=16, output_dim=4):
...
class Porpoise(nn.Module):
    ...
    def forward(self, **kwargs):
        x_path = kwargs["x_path"].squeeze(0)  # (N, 1024)
