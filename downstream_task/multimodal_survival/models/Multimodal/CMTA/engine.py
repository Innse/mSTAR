...
class Engine(object):
    ...
    def train(self, data_loader, model, criterion, optimizer):
        ...
        for batch_idx, (data_ID, data_WSI, data_Omics, data_Event, data_Censorship, data_Label) in enumerate(dataloader):
            ...
            # prediction
            hazards, S, P, P_hat, G, G_hat = model(x_path=data_WSI, x_omic1=data_Omics1, x_omic2=data_Omics2, x_omic3=data_Omics3, x_omic4=data_Omics4, x_omic5=data_Omics5, x_omic6=data_Omics6)

            # survival loss + sim loss + sim loss
            sur_loss = criterion[0](hazards=hazards, S=S, Y=data_Label, c=data_Censorship)
        ...
        for batch_idx, (data_ID, data_WSI, data_Omics, data_Event, data_Censorship, data_Label) in enumerate(dataloader):
            ...
            with torch.no_grad():
                hazards, S, P, P_hat, G, G_hat = model(
                    x_path=data_WSI, x_omic1=data_Omics1, x_omic2=data_Omics2, x_omic3=data_Omics3, x_omic4=data_Omics4, x_omic5=data_Omics5, x_omic6=data_Omics6
